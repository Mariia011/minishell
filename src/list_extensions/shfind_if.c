...
static t_listnode	*__shfind_if__(t_listnode *curr, t_listnode *last, bool (*p)(t_listnode *, t_shell*), t_shell *shell)
{
...
static t_listnode	*__shrfind_if__(t_listnode *curr, t_listnode *last, bool (*p)(t_listnode *, t_shell*), t_shell *shell)
{
